  ...
  (t.prototype = {
    _init: function () {
      ...
      this._preload(),
        ...
        o &&
          ...
          ((e = b('<div class="vegas-timer"><div class="vegas-timer-progress">')),
          (this.$timer = e),
          this.$elmt.prepend(e)),
        a &&
    ...
    options: function (t, s) {
      ...
      this.settings.slides !== i &&
        ((this.total = this.settings.slides.length), (this.noshow = this.total < 2), this._preload());
    },
    destroy: function () {
      clearTimeout(this.timeout),
...
!(function (t, i, e, s) {
  ...
  (o.prototype.transformSupport = function (t) {
    for (
      var o = e.createElement("div"), n = !1, a = null, r = !1, h = null, l = null, p = 0, c = this.vendors.length;
      c > p;
      p++
    )
      if (
        (null !== this.vendors[p]
          ? ((h = this.vendors[p][0] + "transform"), (l = this.vendors[p][1] + "Transform"))
      ...
      case "3D":
        if (n) {
          var m = e.body || e.createElement("body"),
            ...
            y = u.style.overflow;
          e.body ||
            ((u.style.overflow = "hidden"), u.appendChild(m), (m.style.overflow = "hidden"), (m.style.background = "")),
            m.appendChild(o),
    ...
    (o.prototype.onAnimationFrame = function () {
      ...
      (Math.abs(t) > this.calibrationThreshold || Math.abs(i) > this.calibrationThreshold) && this.queueCalibration(0),
        this.portrait
          ? ((this.mx = this.calibrateX ? i : this.iy), (this.my = this.calibrateY ? t : this.ix))
          : ((this.mx = this.calibrateX ? t : this.ix), (this.my = this.calibrateY ? i : this.iy)),
    ...
    for (var t = 0, i = ["ms", "moz", "webkit", "o"], e = 0; e < i.length && !window.requestAnimationFrame; ++e)
      (window.requestAnimationFrame = window[i[e] + "RequestAnimationFrame"]),
        (window.cancelAnimationFrame =
          window[i[e] + "CancelAnimationFrame"] || window[i[e] + "CancelRequestAnimationFrame"]);
  ...
  (jQuery.mbYTPlayer = {
                  ...
                  if (!a.isInit) {
                    ...
                    new YT.Player(a.playerID, {
                      ...
                      events: {
                        onReady: function (c) {
                          (a.player = c.target),
                            a.player.loadVideoById({ videoId: a.videoID.toString(), suggestedQuality: a.opt.quality }),
                          ...
                          if ("function" == typeof b.target.getPlayerState) {
                            ...
                            switch (c) {
                              ...
                              case 1:
                                (d = "YTPPlay"),
                                  a.controlBar.length &&
                                    a.controlBar.find(".mb_YTPPlaypause").html(jQuery.mbYTPlayer.controls.pause);
                                break;
                              case 2:
                                (d = "YTPPause"),
                                  a.controlBar.length &&
                                    a.controlBar.find(".mb_YTPPlaypause").html(jQuery.mbYTPlayer.controls.play);
                                break;
                              case 3:
                        ...
                        return a.isReady
                          ...
                          : ((a.playerEl = a.player.getIframe()),
                            ...
                            a.opt.remember_last_time &&
                              jQuery(window).on("unload.YTP_" + a.id, function () {
      ...
      if (
            ...
            if (a.hasData && a.isPlayer && !a.opt.autoPlay) {
              var b =
                "false" != a.opt.coverImage
                  ? a.opt.coverImage
                  : a.videoData.thumb_max || a.videoData.thumb_high || a.videoData.thumb_medium;
        ...
        jQuery.getJSON(
          ...
          function (b) {
            function c(b) {
              (a.videoData = {}),
                ...
                (a.videoData.description =
                  b.description.length < 400 ? b.description : b.description.substring(0, 400) + " ..."),
            ...
            (d.time = a.currentTime),
              (d.videoId = a.videoID),
              jQuery(a).trigger(d),
              b.items[0] ? (c(b.items[0].snippet), (a.hasData = !0)) : ((a.videoData = {}), (a.hasData = !1));
        ...
        if (
          ...
          var b =
            "false" != a.opt.coverImage
              ? a.opt.coverImage
              : jQuery.mbYTPlayer.locationProtocol + "//i.ytimg.com/vi/" + a.videoID + "/maxresdefault.jpg";
          b &&
            a.opt.containment.css({
              background: "rgba(0,0,0,0.5) url(" + b + ") center center",
              backgroundSize: "cover",
      ...
      (c.opt.startAt = 0),
        ...
        jQuery(c.playerEl).CSSAnimate({ opacity: 0 }, c.opt.fadeOnStartTime, function () {
          jQuery.mbYTPlayer.getDataFromAPI(c),
            b.YTPGetPlayer().loadVideoById({ videoId: c.videoID, suggestedQuality: c.opt.quality }),
            b.YTPPause(),
            b.optimizeDisplay(),
            b.YTPCheckForState();
        });
    ...
    toggleLoops: function () {
      var a = this.get(0),
        b = a.opt;
      return (
        1 == b.loop ? (b.loop = 0) : (b.startAt ? a.player.seekTo(b.startAt) : a.player.playVideo(), (b.loop = 1)), this
      );
    },
    play: function () {
      var a = this.get(0);
    ...
    toggleFilter: function (a, b) {
      var c = this,
        d = c.get(0);
      return (
        d.filters[a].value ? (d.filters[a].value = 0) : (d.filters[a].value = b),
    ...
    toggleFilters: function (a) {
      ...
      return (
        c.filtersEnabled
          ? (jQuery(c).trigger("YTPDisableFilters"), jQuery(c).YTPDisableFilters())
          : (jQuery(c).YTPEnableFilters(), jQuery(c).trigger("YTPEnableFilters")),
            ...
            if (YTPlayer.isReady) {
              ...
              if (
                ...
                isOnScreen || 1 != YTPlayer.state
                  ? isOnScreen && !YTPlayer.isOnScreen && ((YTPlayer.isOnScreen = !0), YTPlayer.player.playVideo())
  ...
  (e.fn.cycle = function (i) {
    ...
    (e.fn.cycle.API = {
      ...
      calcTx: function (t, i) {
        ...
        return (
          s._tempFx
            ? (n = e.fn.cycle.transitions[s._tempFx])
      ...
      prepareTx: function (e, t) {
        ...
        return l.slideCount < 2
          ...
          : (!e ||
              ...
              (l.API.stopTransition(), (l.busy = !1), clearTimeout(l.timeoutId), (l.timeoutId = 0)),
            void (
              l.busy ||
              ((0 !== l.timeoutId || e) &&
      ...
      queueTransition: function (t, i) {
        ...
        return 0 === n.nextSlide && 0 === --n.loop
          ...
          : void 0 !== n.continueAuto &&
            (n.continueAuto === !1 || (e.isFunction(n.continueAuto) && n.continueAuto() === !1))
      ...
      updateView: function (e, t, i) {
        ...
        if (n._initialized) {
          ...
          (!e && t !== !0 && (n.API.trigger("cycle-update-view-before", [n, s, o]), n.updateView < 0)) ||
            (n.slideActiveClass &&
              n.slides.removeClass(n.slideActiveClass).eq(n.currSlide).addClass(n.slideActiveClass),
    ...
    (e.fn.cycle.transitions = {
      ...
      fade: {
        before: function (t, i, n, s) {
          ...
          t.API.stackSlides(i, n, s),
            (t.cssBefore = e.extend(o, { opacity: 0, visibility: "visible", display: "block" })),
            (t.animIn = { opacity: 1 }),
            (t.animOut = { opacity: 0 });
        },
      },
      fadeout: {
        before: function (t, i, n, s) {
          var o = t.API.getSlideOpts(t.nextSlide).slideCss || {};
          t.API.stackSlides(i, n, s),
            (t.cssBefore = e.extend(o, { opacity: 1, visibility: "visible", display: "block" })),
            (t.animOut = { opacity: 0 });
        },
      },
      scrollHorz: {
        before: function (e, t, i, n) {
          ...
          (e.cssBefore = { left: n ? s : -s, top: 0, opacity: 1, visibility: "visible", display: "block" }),
      ...
      scrollVert: {
        before: function (e, t, i, n) {
          ...
          (e.cssBefore = { top: n ? -s : s, left: 0, opacity: 1, visibility: "visible", display: "block" }),
            (e.cssAfter = { zIndex: e - 1, top: 0 }),
            (e.animIn = { top: 0 }),
            (e.animOut = { top: n ? s : -s });
        },
      },
      ...
      e(document).on("cycle-initialized", function (i, o) {
        ...
        ("string" === a || "number" === a) &&
          ...
          "container" == r
            ...
            : "string" === a &&
              /\d+\:\d+/.test(r) &&
              ((l = r.match(/(\d+)\:(\d+)/)), (l = l[1] / l[2]), (o._autoHeightRatio = l)),
          "number" !== a &&
      ...
      e(document).on("cycle-bootstrap", function (t, i) {
        function n(t, n) {
          function o(t) {
            var o;
            "wait" == i.loader
              ? (l.push(t), 0 === a && (l.sort(c), s.apply(i.API, [l, n]), i.container.removeClass("cycle-loading")))
          ...
          else if ("array" === e.type(t)) for (var r = 0; r < t.length; r++) t[r] = e(t[r])[0];
          t = e(t);
          var a = t.length;
          a &&
            (t
          ...
          return (
            ...
            t.replace(n, function (t, i) {
              ...
              for (n = 0; n < s.length; n++)
                if ((c = s[n])) {
                  if (r.length > 1) for (l = c, o = 0; o < r.length; o++) (c = l), (l = l[r[o]] || i);
                  else l = c[i];
  ...
  i.fn.cycle.transitions.scrollVert = {
    before: function (i, t, e, s) {
      ...
      i.API.stackSlides(i, t, e, s),
        (i.cssBefore = { top: s ? -o : o, left: 0, opacity: 1, display: "block", visibility: "visible" }),
        (i.animIn = { top: 0 }),
        (i.animOut = { top: s ? o : -o });
    },
  };
    ...
    glitch: function () {
      ...
      function s() {
        var i = e(10, 1900),
          ...
          f = e(0, 16),
          d = e(c, l);
        t(r).css({ clip: "rect(" + i + "px, " + n + "px, " + a + "px," + o + "px)", right: f, left: h }),
          setTimeout(s, d);
      }
      function i() {
        var s = e(10, 1900),
      ...
      if (this.settings.destroy === !0)
        (t(r).hasClass("el-front-1") || t(r).hasClass("front-3") || t(r).hasClass("front-2")) &&
...
var option_overlay_skin = "black",
  ...
  option_hero_background_slider_delay = 2000,
  ...
  option_hero_background_kenburns_delay = 2000,
...
function getUrlParameter(e) {
  ...
  for (a = 0; a < t.length; a++) if ((o = t[a].split("="))[0] === e) return void 0 === o[1] || o[1];
}
if (
    ...
    $(".options-panel .panel-button").click(function () {
      ...
      $("#overlay-animation p").click(function () {
        $("#overlay-animation p").removeClass("active"),
          $(this).addClass("active"),
          $(this).hasClass("overlay-animation-fade")
      ...
      $("#overlay-content-animation p").click(function () {
        $("#overlay-content-animation p").removeClass("active"),
          $(this).addClass("active"),
          $(this).hasClass("overlay-content-animation-fade")
            ? ($("#overlay > .overlay").addClass("edit"),
...
if (
  (isMobile.any() && jQuery("body").addClass("is-mobile"),
  $(document).ready(function () {
    "use strict";
    !(function (e, o, a, s) {
      var t,
          ...
          0 === f &&
            ...
            setTimeout(function () {
              (prevent_class_removal = !0),
                ...
                u.addClass("show"),
                "youtube" === option_hero_background_mode &&
                  setTimeout(function () {
      ...
      function g() {
        "on" !== option_overlay_bullet_navigation ||
      ...
      switch (
        (isMobile.any() &&
          "on" == option_overlay_merge_sections_on_mobile &&
          (jQuery("body").addClass("merge-true"), (v = 1), $(".social_icons li .go-down").parent().remove()),
        "on" !== option_overlay_bullet_navigation ||
          $(".hero").hasClass("error-404") ||
          (function () {
            ...
            success: function (e) {
              $(".subscribe-form").removeClass("error").removeClass("error-final"),
                0 === e.valid
                  ...
                  : ($(".subscribe-form input,.subscribe-form button").val("").prop("disabled", !0),
                    $(".subscribe-form input").attr("placeholder", e.message),
        ...
        $.ajax({
          ...
          success: function (e) {
            $("#contact-form.error input, #contact-form.error textarea").removeClass("active"),
              setTimeout(function () {
                "" !== e.nameMessage &&
                  ($("#contact-form-name").addClass("active").attr("placeholder", e.nameMessage),
                  $("#contact-form").addClass("error")),
                  "" !== e.emailMessage &&
                    ($("#contact-form-email").addClass("active").val("").attr("placeholder", e.emailMessage),
                    $("#contact-form").addClass("error")),
                  "" !== e.messageMessage &&
                    ($("#contact-form-message").addClass("active").attr("placeholder", e.messageMessage),
                    $("#contact-form").addClass("error"));
              }, 50),
              "" === e.nameMessage &&
                "" === e.emailMessage &&
...
$(document).ready(function () {
  "use strict";
  function t() {
    $(".bg-image").vegas({ slides: option_hero_background_image_path, delay: 6e3, transitionDuration: 800, timer: !1 });
  }
  function e() {
    ...
    !(function () {
      ...
      for (
        var r = 2 * Math.PI,
          h = new THREE.SpriteCanvasMaterial({
            color: option_hero_background_sphere_dot_color,
            program: function (t) {
              t.beginPath(), t.arc(0, 0, 0.5, 0, r, !0), t.fill();
            },
          }),
          g = 0;
        g < 1e3;
      ...
      for (var g = 0; g < 300; g++) {
        ...
        var m = _.clone();
        m.multiplyScalar(0.3 * Math.random() + 1), p.vertices.push(m);
        var f = new THREE.Line(
          p,
          new THREE.LineBasicMaterial({ color: option_hero_background_sphere_line_color, opacity: Math.random() })
        );
        e.add(f);
      }
      ...
      (function i() {
        ...
        g &&
          ((t.position.x += 0.05 * (a - t.position.x)),
          (t.position.y += 0.05 * (200 - s - t.position.y)),
          t.lookAt(e.position),
  ...
  function o() {
    ...
    var t,
      ...
      n,
      a,
      s = option_hero_background_waves_dotSpacing,
    ...
    !(function () {
      ...
      for (
        var u = 2 * Math.PI,
          d = new THREE.SpriteCanvasMaterial({
            ...
            program: function (t) {
              t.beginPath(), t.arc(0, 0, 0.5, 0, u, !0), t.fill();
            },
          }),
          g = 0,
          p = 0;
      ...
      (function t() {
        ...
        !(function () {
          if (y) {
            (e.position.x += 0.05 * (d - e.position.x)),
              (e.position.y += 0.05 * (-g - e.position.y)),
              e.lookAt(o.position);
            for (var t = 0, s = 0; s < r; s++)
              for (var c = 0; c < h; c++)
                ((a = n[t++]).position.y = 50 * Math.sin(0.3 * (s + u)) + 50 * Math.sin(0.5 * (c + u))),
                  (a.scale.x = a.scale.y = 4 * (Math.sin(0.3 * (s + u)) + 1) + 4 * (Math.sin(0.5 * (c + u)) + 1));
            i.render(o, e), (u += 0.1);
          }
        })();
      })();
        ...
        (function () {
          ...
          for (l = n.vertices.length - 1; l >= 0; l--)
            (u = n.vertices[l]),
              ...
              FSS.Vector3.set(
                u.position,
                h.xRange * n.segmentWidth * e,
                h.yRange * n.sliceHeight * i,
                h.zRange * p * a - p
              ),
    ...
    if (
      ...
      setInterval(function () {
        for (var t = 1; t <= 1e3; t++)
          x.beginPath(),
            w
              ? (x.moveTo(0, randomize(canvas.height + 10)), (w = !1))
              : (x.moveTo(randomize(canvas.width + 10), 0), (w = !0)),
        ...
        function t(t, e) {
          ...
          function c() {
            (this.x = Math.random() * t.width),
              ...
              (this.vx = h.velocity - 0.5 * Math.random()),
              (this.vy = h.velocity - 0.5 * Math.random()),
          ...
          (c.prototype = {
                ...
                for (i = 0; i < n; i++)
                  (t = h.stars[o]),
                    ...
                    t.x - e.x < h.distance &&
                      ...
                      t.x - e.x > -h.distance &&
                      t.y - e.y > -h.distance &&
                      t.x - h.position.x < h.radius &&
                      t.y - h.position.y < h.radius &&
                      t.x - h.position.x > -h.radius &&
                      t.y - h.position.y > -h.radius &&
                      (s.beginPath(), s.moveTo(t.x, t.y), s.lineTo(e.x, e.y), s.stroke(), s.closePath());
            },
          }),
            (this.createStars = function () {
              var e,
                o,
                i = h.length;
              for (s.clearRect(0, 0, t.width, t.height), o = 0; o < i; o++)
                h.stars.push(new c()), (e = h.stars[o]).create();
            ...
            (this.setCanvas = function () {
              (t.width = h.width),
                ...
                (e && e.hasOwnProperty("position")) || (h.position = { x: 0.5 * t.width, y: 0.5 * t.height });
            }),
  ...
  switch (option_hero_background_mode) {
      ...
      (r = option_hero_background_gradient_colorArray),
        ...
        setInterval(function () {
          var t = r[l[0]],
            ...
            a =
              "rgb(" +
              Math.round(n * t[0] + h * e[0]) +
              "," +
              Math.round(n * t[1] + h * e[1]) +
              "," +
              Math.round(n * t[2] + h * e[2]) +
              ")",
            s =
              "rgb(" +
              Math.round(n * o[0] + h * i[0]) +
              "," +
              Math.round(n * o[1] + h * i[1]) +
              "," +
              Math.round(n * o[2] + h * i[2]) +
              ")";
          c
            .css({ background: "-webkit-gradient(linear, left top, right top, from(" + a + "), to(" + s + "))" })
            .css({ background: "-moz-linear-gradient(left, " + a + " 0%, " + s + " 100%)" }),
            (h += u) >= 1 &&
              ((h %= 1),
              (l[0] = l[1]),
              (l[2] = l[3]),
    ...
    case "mesh":
      !(function () {
            ...
            (function () {
              for (var t = -n / 2; t < o + n; t += n) {
                ...
                for (var e = -n / 2; e < i + n; e += n)
                  t == -n / 2 && d++, g.push(new _({ x: ~~(t + m(-a, a)), y: ~~(e + m(-a, a)) }));
              }
            })(),
        ...
        function v() {
          requestAnimationFrame(v),
            l || ((c.x = o / 2 + 90 * Math.cos(p / 40)), (c.y = i / 2 + 90 * Math.sin(p / 40))),
              ...
              for (var t = 0; t < u; t++)
                for (var n = 0; n < d; n++)
                  (s = g[t * d + n]),
                    ...
                    r && (e.moveTo(s.x, s.y), e.lineTo(r.x, r.y)),
                    h && (e.moveTo(s.x, s.y), e.lineTo(h.x, h.y));
              e.stroke(),
                (e.fillStyle = "#000"),
                g.forEach(function (t) {
                  e.save(),
        ...
        (_.prototype.step = function () {
          ...
          var t,
            ...
            o,
            i,
            n = ((e = c), (o = (t = this).x - e.x), (i = t.y - e.y), Math.atan2(i, o));
      ...
      !(function (t, e, o, i) {
        ...
        !(function () {
          ...
          e.requestAnimationFrame ||
            (e.requestAnimationFrame = function (o, i) {
            ...
            init: function () {
              ...
              (this.n = parseInt(
                -1 != i.indexOf("n=")
                  ? i.substring(
                      i.indexOf("n=") + 2,
                      -1 != i.substring(i.indexOf("n=") + 2, i.length).indexOf("&")
                        ? i.indexOf("n=") + 2 + i.substring(i.indexOf("n=") + 2, i.length).indexOf("&")
                        : i.length
                    )
                ...
                s.starz[0].getContext && ((s.context = s.starz[0].getContext("2d")), (c = !0)),
            ...
            anim: function () {
              ...
              for (var t = 0; t < this.n; t++)
                (this.test = !0),
                  ...
                  this.star[t][0] > this.x << 1 && ((this.star[t][0] -= this.w << 1), (this.test = !1)),
                  this.star[t][0] < -this.x << 1 && ((this.star[t][0] += this.w << 1), (this.test = !1)),
                  (this.star[t][1] += this.mouse_y >> 4),
                  this.star[t][1] > this.y << 1 && ((this.star[t][1] -= this.h << 1), (this.test = !1)),
                  this.star[t][1] < -this.y << 1 && ((this.star[t][1] += this.h << 1), (this.test = !1)),
                  (this.star[t][2] -= this.star_speed),
                  this.star[t][2] > this.z && ((this.star[t][2] -= this.z), (this.test = !1)),
                  this.star[t][2] < 0 && ((this.star[t][2] += this.z), (this.test = !1)),
                  ...
                  this.star_x_save > 0 &&
                    ...
                    this.test &&
                    ((this.context.lineWidth = 2 * (1 - this.star_color_ratio * this.star[t][2])),
                ...
                ? e.addEventListener(
                    ...
                    function (t) {
                      if (null !== t.beta && null !== t.gamma) {
                        var e = t.gamma,
                          o = t.beta;
                        s.portrait || ((e = -1 * t.beta), (o = t.gamma)),
  ...
  if ("on" == option_hero_parallax_hover_effect) {
    var d = $(".hero").parallax({ scalarX: 24, scalarY: 15, frictionX: 0.1, frictionY: 0.1 });
    $(".hero").hover(
      function () {
        d.parallax("enable");
      },
  ...
  "slider" === option_hero_background_mode &&
    ((g = option_hero_background_slider_transitionDuration), (p = option_hero_background_slider_delay)),
    "kenburns" === option_hero_background_mode &&
      ((g = option_hero_background_kenburns_transitionDuration), (p = option_hero_background_kenburns_delay)),
    $("#cycle").cycle({
      fx: "scrollVert",
      timeout: p,
      delay: 0,
